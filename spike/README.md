...
Phase 1 で `Kotoyomi::JS.eval` の最小プロトタイプ、Phase 2a–2c で primitive 一式と
...
│   └── kotoyomi-js/
│       ├── mrbgem.rake
│       ├── src/kotoyomi_js.c        # C primitive (WASM imports + Value)
│       └── mrblib/kotoyomi_js.rb    # BasicObject ベースの Ruby ラッパー
